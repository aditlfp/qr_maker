                    ...
                    <div class="flex items-center justify-between mb-6">
                        <label class="label cursor-pointer gap-2 p-0">
                            <input type="checkbox" id="remember_me" name="remember"
                                class="checkbox checkbox-sm bg-white/20 border-white/30" />
                            <span class="label-text text-white/90 text-sm">{{ __('Remember me') }}</span>
                        </label>

                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-sm text-white/90 hover:text-white">
                                {{ __('Forgot password?') }}
                            </a>
                        @endif
                    </div>
